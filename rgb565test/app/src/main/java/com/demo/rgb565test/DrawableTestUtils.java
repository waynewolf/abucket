...
public class DrawableTestUtils {
    private static final String LOGTAG = "rgb565test";
    ...
    static final int PIXEL_ERROR_TOLERANCE = 6;
    ...
    public static void compareImages(String message, Bitmap expected, Bitmap actual,
        ...
        if ((totalDiffPixelCount / totalPixelCount) >= pixelCountThreshold) {
            Log.e(LOGTAG, "compare failed: " + message +": totalDiffPixelCount is " + totalDiffPixelCount);
        } else {
            Log.e(LOGTAG, "compare success, cts should pass too");
        }
    }
